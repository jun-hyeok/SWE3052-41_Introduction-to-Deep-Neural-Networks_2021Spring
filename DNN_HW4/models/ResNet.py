...
class ResNet(nn.Module):
    def __init__(self, input_channel, output_dim, learning_rate, reg_lambda, device):
        ...
        # =============================== EDIT HERE ===============================
        self.residualBlock1 = BasicBlock(in_channels=64, out_channels=64)
        self.residualBlock2 = BasicBlock(in_channels=64, out_channels=64)
        self.residualBlock3 = BasicBlock(in_channels=64, out_channels=128, stride=2)
        self.residualBlock4 = BasicBlock(in_channels=128, out_channels=128)
        self.residualBlock5 = BasicBlock(in_channels=128, out_channels=256, stride=2)
        self.residualBlock6 = BasicBlock(in_channels=256, out_channels=256)
        self.residualBlock7 = BasicBlock(in_channels=256, out_channels=512, stride=2)
        self.residualBlock8 = BasicBlock(in_channels=512, out_channels=512)
        self.POOL2 = nn.AvgPool2d(kernel_size=(7, 7))
    ...
    def forward(self, x):
        ...
        h = torch.relu(h)
        h = self.POOL1(h)
        h = self.residualBlock1(h)
        h = self.residualBlock2(h)
        h = self.residualBlock3(h)
        h = self.residualBlock4(h)
        h = self.residualBlock5(h)
        h = self.residualBlock6(h)
        h = self.residualBlock7(h)
        h = self.residualBlock8(h)
        h = self.POOL2(h)
